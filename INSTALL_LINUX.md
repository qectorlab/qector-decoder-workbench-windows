# QECTOR Decoder Workbench v1.0.4 - Linux
...
unzip QectorWorkbench-Linux-v1.0.4.zip
...
```bash
sudo dpkg -i qector-workbench_1.0.4_amd64.deb
...
```
SHA-256 (ZIP):      TBD  QectorWorkbench-Linux-v1.0.4.zip
SHA-256 (Portable): TBD  QectorWorkbench-Portable
```

Verify locally: `sha256sum QectorWorkbench-Portable` and `sha256sum QectorWorkbench-Linux-v1.0.4.zip`.
